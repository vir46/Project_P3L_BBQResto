    ...
    <div class="container">
      ...
      <div class="paypal__header">
        ...
        <div class="paypal__header-info">
          <span class="paypal__date">Income</span>
        </div>
      </div>

      <div class="paypal__cart">
        <h2 class="paypal__cart-title"></h2>

        <ul class="paypal__cart-list">
          <li class="paypal__cart-item">
            <span class="paypal__item-name">Squid</span>
            <br>
            <span class="paypal__item-price">Total Incoming: Rp.20500</span>
          </li>
