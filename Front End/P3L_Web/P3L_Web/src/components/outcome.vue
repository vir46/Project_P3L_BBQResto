    ...
    <div class="container">
      ...
      <div class="paypal__header">
        ...
        <div class="paypal__header-info">
          <span class="paypal__date">Outcome</span>
        </div>
      </div>

      <div class="paypal__cart">
        <h2 class="paypal__cart-title">Your Refill</h2>
        ...
        <ul class="paypal__cart-list">
          <li class="paypal__cart-item">
            ...
            <br>
            <span class="paypal__item-price">Total: 60</span>
          </li>
          ...
          <li class="paypal__cart-item">
            ...
            <br>
            <span class="paypal__item-price">Total: 90</span>
          </li>
