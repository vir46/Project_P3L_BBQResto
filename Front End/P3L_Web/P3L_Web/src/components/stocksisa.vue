    ...
    <div class="container">
      ...
      <div class="paypal__header">
        <div class="paypal__logo-wrapper">
          <img src="https://i.ibb.co/dprLS5Q/akb-removebg-preview.png" alt="Paypal" class="paypal__logo">
        </div>

        <div class="paypal__header-info">
          <span class="paypal__date">STOCK LAPORAN</span>
        </div>
      </div>

      <div class="paypal__cart">
        <h2 class="paypal__cart-title">Remaining</h2>

        <ul class="paypal__cart-list">
            <li class="paypal__cart-item">
            <span class="paypal__index">1</span>
            <span class="paypal__item-name">Daging Sapi</span>
            <br>
            <span class="paypal__item-price">Isi: 0</span>
          </li>

          <li class="paypal__cart-item">
            <span class="paypal__index">1</span>
            <span class="paypal__item-name">Daging Cumi</span>
            <br>
            <span class="paypal__item-price">Isi: 125</span>
          </li>

          <li class="paypal__cart-item">
            <span class="paypal__index">2</span>
            <span class="paypal__item-name">Asinan Sayur</span>
            <br>
            <span class="paypal__item-price">Isi: 90</span>
          </li>
